        ...
        {navItems.map(({ id, view, icon, label }) => {
          ...
          return (
            <Link
              ...
              className={`flex flex-col items-center justify-center transition-colors active:scale-90 duration-200 ease-out ${
                isActive
                  ? "text-primary relative after:content-[''] after:w-1 after:h-1 after:bg-primary after:rounded-full after:mt-1"
            ...
            >
              ...
              <span className="font-body font-semibold text-[10px] tracking-wide">{label}</span>
            </Link>
          )
        })}
      </div>
